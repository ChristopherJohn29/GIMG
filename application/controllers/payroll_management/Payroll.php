...
class Payroll extends \Mobiledrs\core\MY_Controller {
	...
	public function invoice()
	{
		...
		$page_data['invoiceNumber'] =  'GIMG_'.str_pad($invID, 6, '0', STR_PAD_LEFT);
	...
	public function sendInvoice()
	{
		...
		$this->load->library(['email', 'PDF']);
			...
			$this->email->from('payroll@global-img.com', 'Global Integrated Medical Group');
			$this->email->to($email); //
			$this->email->cc('globalimg@yahoo.com');
