...
class Cookie extends CI_Controller {
    ...
    public function generate_cookie(){
        ...
        echo "<center><br><br>
        <br>
        <br>The EHR System is restricted to Global Integrated Medical Group employees only.
        <br>
        <br>
        If you are an employee and wish to access the EHR System,<br> send the unique Browser Token below to your admin.  <br> <br>
        ";
        
        if(!isset($_COOKIE['computer_cookie'])) {
            setcookie('computer_cookie', $cookie_value, time() + (86400 * 300), "/"); // 86400 = 1 day
            echo 'Your unique Browser Token is <label style="color:green;">' . $cookie_value . "<br>";
        } else {
            echo 'Your unique Browser Token is <label style="color:green;">' . $_COOKIE['computer_cookie'] . "<br>";
        }   
