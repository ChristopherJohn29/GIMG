	  ...
	  <div class="row">
          ...
          <div class="box">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Update Cognitive Visit Route Sheet</h3>
            </div>
            <!-- /.box-header -->
							...
							<input type="hidden" name="is_ca" value="1">
								...
								<div class="row">
									...
									<div class="col-md-12 form-group {{ form_error('prs_dateOfService') ? 'has-error' : '' }}">
										...
										<input type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask required="true" name="prs_dateOfService" value="{{ set_value('prs_dateOfService', record.get_date_format(record.prs_dateOfService)) }}" data-ajaxUrl="{{ site_url('ajax/provider_route_sheet_management/route_sheet/check_provider_routesheet_by_date_ca') }}">
								...
								<div class="row">
											...
											<div class="patient-details-item ui-state-default pull-left" style="border:none;" {{ index > 0 ? "data-item-num=#{ index + 1 }" }}>
												...
												<div class="col-md-6 form-group {{ form_error('prsl_tovID') ? 'has-error' : '' }}">
													...
													<select class="form-control" style="width: 100%;" required="true" name="prsl_tovID[]">
														<option {{ list.prsl_tovID == 2000000016 ? 'selected' : ''}} value="2000000016">Cognitive Assesment (Home Visits)</option>
														<option {{ list.prsl_tovID == 2000000017 ? 'selected' : ''}} value="2000000017">Cognitive Assesment (Telehealth)</option>>
													</select>
									...
									<div class="col-md-12 form-group xrx-btn-handler">
                                        <a href="{{ site_url('provider_route_sheet_management/route_sheet/index/ca') }}" class="btn btn-default xrx-btn cancel">
											Cancel
										</a>
