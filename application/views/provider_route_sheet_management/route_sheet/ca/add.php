	  ...
	  <div class="row">
          ...
          <div class="box">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Create Cognitive Visit Route Sheet</h3>
            </div>
            <!-- /.box-header -->
							...
							<input type="hidden" name="is_ca" value="1">
								<div class="row">
									...
									<div class="col-md-12 form-group {{ form_error('prs_dateOfService') ? 'has-error' : '' }}">
										...
										<input type="text" class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask required="true" name="prs_dateOfService" data-ajaxUrl="{{ site_url('ajax/provider_route_sheet_management/route_sheet/check_provider_routesheet_by_date_ca') }}">
